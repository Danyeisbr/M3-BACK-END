...
/*   readFile('poem-one/stanza-01.txt', function (err, stanza) {
  ...
  // AsyncAwait version
const lecture = await promisifiedReadFile('poem-one/stanza-01.txt')
blue(lecture)
...
/*   const resultado = await promisifiedReadFile('poem-one/stanza-02.txt')
  blue(resultado);

  const resultado2 = await promisifiedReadFile('poem-one/stanza-03.txt')
  blue(resultado2); */
